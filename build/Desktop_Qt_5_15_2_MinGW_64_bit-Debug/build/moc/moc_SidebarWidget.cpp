...
#include <memory>
#include "../../../../include/SidebarWidget.h"
...
QT_MOC_LITERAL(1, 14, 14), // "navItemClicked"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 9), // "pageIndex"
QT_MOC_LITERAL(4, 40, 10) // "breadcrumb"

    },
    "SidebarWidget\0navItemClicked\0\0pageIndex\0"
    "breadcrumb"
};
...
void SidebarWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->navItemClicked((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SidebarWidget::*)(int , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SidebarWidget::navItemClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SidebarWidget::navItemClicked(int _t1, const QString & _t2)
{
