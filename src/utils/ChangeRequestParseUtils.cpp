...
QString inferEditIntentFromText(const QString& text)
{
    ...
    static const QStringList rotationKeywords = {
        ...
        QString::fromUtf8("朝向"),
        QString::fromUtf8("指向"),
        QString::fromUtf8("调整方向"),
        QString::fromUtf8("改变方向"),
        QString::fromUtf8("方向"),
        QString::fromUtf8("翻转"),
        QString::fromUtf8("面向"),
        QStringLiteral("rotate"),
        QStringLiteral("flip"),
        QStringLiteral("turn toward"),
        QStringLiteral("point toward"),
    ...
    if (ChangeRequestIntentUtils::isLightingEditIntentText(lower)
        && containsAnyKeyword(lower, backgroundChangeKeywords)) {
        return QStringLiteral("replace_lighting");
    }
