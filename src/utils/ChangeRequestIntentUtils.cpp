...
bool containsAnyKeywordLower(const QString& lowerText, const QStringList& keywords)
{
    for (const QString& kw : keywords) {
        if (lowerText.contains(kw.toLower())) {
            return true;
        }
    }
    return false;
...
bool isBackgroundEditIntentText(const QString& text)
{
    ...
    static const QStringList keywords = {
        QString::fromUtf8("背景"), QString::fromUtf8("场景"),
        QString::fromUtf8("环境"), QString::fromUtf8("风景"), QString::fromUtf8("地点"),
        QStringLiteral("background"), QStringLiteral("scene"),
        QStringLiteral("environment"), QStringLiteral("setting"), QStringLiteral("location")
    };
    return containsAnyKeywordLower(lower, keywords);
}
...
QString buildReplacementSubjectPrompt(const QString& subject,
...
QString buildMovementSubjectPrompt(const QString& subject,
...
bool isLightingEditIntentText(const QString& text)
{
    ...
    if (lower.isEmpty()) return false;
    static const QStringList keywords = {
        QString::fromUtf8("光线"), QString::fromUtf8("光照"), QString::fromUtf8("光效"),
        QString::fromUtf8("亮度"), QString::fromUtf8("色调"), QString::fromUtf8("氛围"),
        QString::fromUtf8("夜晚"), QString::fromUtf8("白天"), QString::fromUtf8("傍晚"),
        QString::fromUtf8("黄昏"), QString::fromUtf8("黎明"), QString::fromUtf8("清晨"),
        QString::fromUtf8("午后"), QString::fromUtf8("雨天"), QString::fromUtf8("雪天"),
        QString::fromUtf8("阴天"), QString::fromUtf8("晴天"), QString::fromUtf8("暖色"),
        QString::fromUtf8("冷色"), QString::fromUtf8("昏暗"), QString::fromUtf8("明亮"),
        QStringLiteral("lighting"), QStringLiteral("light"), QStringLiteral("brightness"),
        QStringLiteral("tone"), QStringLiteral("mood"), QStringLiteral("atmosphere"),
        QStringLiteral("night"), QStringLiteral("day"), QStringLiteral("dawn"),
        QStringLiteral("dusk"), QStringLiteral("evening"), QStringLiteral("morning"),
        QStringLiteral("rainy"), QStringLiteral("snowy"), QStringLiteral("warm"),
        QStringLiteral("cold"), QStringLiteral("dark"), QStringLiteral("bright")
    };
    return containsAnyKeywordLower(lower, keywords);
}
...
QString extractLightingSubject(const QJsonObject& params)
{
    ...
    return QStringLiteral("光线氛围");
}

QString buildLightingEditPrompt(const QJsonObject& params)
{
    const QString subject = extractLightingSubject(params);
    return LocalEditPromptUtils::buildLocalBackgroundEditPrompt(
        QStringLiteral("整体光线与氛围"),
        subject,
        QStringLiteral("保持人物、构图、透视、镜头、场景结构和画幅比例不变，只调整光线、色调和氛围"),
        1.0);
}
