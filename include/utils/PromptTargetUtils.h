...
inline bool containsAny(const QString& text, const QStringList& keywords)
{
...
inline bool isSceneFocusedPrompt(const QString& text)
{
...
inline bool isCharacterFocusedPrompt(const QString& text)
{
    static const QStringList keywords = {
...
inline bool isRemovalIntentText(const QString& text)
{
...
inline bool isLocalObjectMovementIntent(const QString& editIntent)
{
...
inline bool isSceneEditIntent(const QString& editIntent)
{
    const QString normalizedIntent = editIntent.trimmed().toLower();
...
inline bool isCharacterEditIntent(const QString& editIntent)
{
    const QString normalizedIntent = editIntent.trimmed().toLower();
...
inline QString resolveTargetFromEditMetadata(const QJsonObject& panelJson)
{
...
inline QString resolveEditPromptTarget(const QJsonObject& panelJson,
...
inline QString classifyPanelPromptTarget(const QJsonObject& panelJson)
{
