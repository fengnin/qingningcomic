...
namespace Job {
    inline QString typeLabel(const QString& type) {
        static const QMap<QString, QString> labels = {
            ...
            {"generate_preview", QString::fromUtf8("面板预览")},
            {"generate_hd", QString::fromUtf8("面板高清")},
            {"GeneratePanelImage", QString::fromUtf8("面板图像")},
            {"generate_panel_image", QString::fromUtf8("面板图像")},
